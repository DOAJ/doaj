...
class TestAccountPasswordResetEmail(DoajTestCase):
    ...
    def test_consumes(self):
        event = models.Event(constants.EVENT_ACCOUNT_PASSWORD_RESET, context={"account" : AccountFixtureFactory.make_publisher_source(), "old_status" : "in progress", "new_status": "ready"})
