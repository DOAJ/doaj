...
class TestCrosswalks(DoajTestCase):
    ...
    def test_06_crossref_article_xml_xwalk(self):
        ...
        assert bibjson.author == [{'name': 'Surname Bob', 'orcid_id': 'http://orcid.org/0000-0002-4011-3590'}], "expected [{{'name': 'Surname Bob', 'orcid_id': 'http://orcid.org/0000-0002-4011-3590'}}]', received: {}".format(bibjson.author)
