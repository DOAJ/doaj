...
class TestCreateOrUpdateArticle(DoajTestCase):
    ...
    # these tests check only scenario with admin account - publisher is not able to call create_article with update_article_id not None
    # update_article_id is not None only when create_article is called from admin metadata form
