...
class TestPublicApplicationEmails(DoajTestCase):
    def setUp(self):
        ...
        self.stdout_handler = self.test_app.logger.handlers[0]
        self.test_app.logger.removeHandler(self.stdout_handler)
        ...
        self.test_app.logger.addHandler(self.read_info)
    ...
    def tearDown(self):
        ...
        self.test_app.logger.removeHandler(self.read_info)

        # Re-enable the old log handler
        self.test_app.logger.addHandler(self.stdout_handler)
...
class TestApplicationReviewEmails(DoajTestCase):
    ...
    def test_01_maned_review_emails(self):
        ...
        manEd_to = re.escape(self.test_app.config.get('MANAGING_EDITOR_EMAIL'))
