...
class JournalsCrudApi(CrudApi):
    ...
    def retrieve_swag(cls):
        ...
        template['responses']['200']['description'] = '<a href="https://doaj.github.io/doaj-docs/master/data_models/OutgoingAPIJournal">Detailed documentation on the response format is available</a>. '
