...
INDEX_RECORD_TYPE_UPDATE_REQUEST_UNFINISHED = "Update Request (open)"
INDEX_RECORD_TYPE_UPDATE_REQUEST_FINISHED = "Update Request (closed)"
INDEX_RECORD_TYPE_NEW_APPLICATION_UNFINISHED = "Application (open)"
INDEX_RECORD_TYPE_NEW_APPLICATION_FINISHED = "Application (closed)"
