...
TODO_MANED_STALLED = "Chase <strong>stalled</strong> application"
TODO_MANED_FOLLOW_UP_OLD = "Follow up with <strong>old<strong> application"
TODO_MANED_READY = "Make a decision on <strong>ready<strong> application"
TODO_MANED_COMPLETED = "Review <strong>completed<strong> application"
TODO_MANED_ASSIGN_PENDING = "Assign <strong>pending<strong> application"
