...
DOAJENV=production python -u journals_update_via_csv.py -i <input_csv_path.csv> -a adminuser -d | tee <output_log_path.txt>
...
if __name__ == "__main__":
    ...
    parser.add_argument("-a", "--account", help="account ID of the user to import as", required=True)
