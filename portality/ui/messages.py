...
class Messages(object):
    ...
    CANNOT_CHANGE_THE_STATUS__OTHER_JOURNAL_IN_DOAJ_EXISTS = "The status couldn't be changed. For at least one journal other journals with matching ISSN(s) already exists in doaj"
