...
@api_key_required
@swag(swag_summary='Create applications in bulk', swag_spec=ApplicationsBulkApi.create_swag())  # must be applied after @api_key_(optional|required) decorators. They don't preserve func attributes.
...
@api_key_required
@swag(swag_summary='Delete applications in bulk', swag_spec=ApplicationsBulkApi.delete_swag())  # must be applied after @api_key_(optional|required) decorators. They don't preserve func attributes.
