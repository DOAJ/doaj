...
@api_key_required
@google_analytics_event('API Hit', 'Search applications', record_value_of_which_arg='search_query')
...
@google_analytics_event('API Hit', 'Search journals', record_value_of_which_arg='search_query')
...
@google_analytics_event('API Hit', 'Search articles', record_value_of_which_arg='search_query')
...
@google_analytics_event('API Hit', 'Create application')
...
@google_analytics_event('API Hit', 'Retrieve application', record_value_of_which_arg='application_id')
...
@google_analytics_event('API Hit', 'Update application', record_value_of_which_arg='application_id')
...
@google_analytics_event('API Hit', 'Delete application', record_value_of_which_arg='application_id')
...
@google_analytics_event('API Hit', 'Create article')
def create_article():
    # get the data from the request
    try:
        data = json.loads(request.data)
...
@google_analytics_event('API Hit', 'Retrieve article', record_value_of_which_arg='article_id')
...
@google_analytics_event('API Hit', 'Update article', record_value_of_which_arg='article_id')
...
@google_analytics_event('API Hit', 'Delete article', record_value_of_which_arg='article_id')
...
@google_analytics_event('API Hit', 'Retrieve journal', record_value_of_which_arg='journal_id')
...
@google_analytics_event('API Hit', 'Bulk application create')
...
@google_analytics_event('API Hit', 'Bulk application delete')
...
@google_analytics_event('API Hit', 'Bulk article create')
