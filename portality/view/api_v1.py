...
@api_key_required
@analytics.Google.sends_ga_event('API Hit', 'Search applications', record_value_of_which_arg='search_query')
...
@analytics.Google.sends_ga_event('API Hit', 'Search journals', record_value_of_which_arg='search_query')
...
@analytics.Google.sends_ga_event('API Hit', 'Search articles', record_value_of_which_arg='search_query')
...
@analytics.Google.sends_ga_event('API Hit', 'Create application')
...
@analytics.Google.sends_ga_event('API Hit', 'Retrieve application', record_value_of_which_arg='application_id')
...
@analytics.Google.sends_ga_event('API Hit', 'Update application', record_value_of_which_arg='application_id')
...
@analytics.Google.sends_ga_event('API Hit', 'Delete application', record_value_of_which_arg='application_id')
...
@analytics.Google.sends_ga_event('API Hit', 'Create article')
def create_article():
    # get the data from the request
    try:
        data = json.loads(request.data)
...
@analytics.Google.sends_ga_event('API Hit', 'Retrieve article', record_value_of_which_arg='article_id')
...
@analytics.Google.sends_ga_event('API Hit', 'Update article', record_value_of_which_arg='article_id')
...
@analytics.Google.sends_ga_event('API Hit', 'Delete article', record_value_of_which_arg='article_id')
...
@analytics.Google.sends_ga_event('API Hit', 'Retrieve journal', record_value_of_which_arg='journal_id')
...
@analytics.Google.sends_ga_event('API Hit', 'Bulk application create')
...
@analytics.Google.sends_ga_event('API Hit', 'Bulk application delete')
...
@analytics.Google.sends_ga_event('API Hit', 'Bulk article create')
