...
from portality import legacy_datasets
...
currency_options = legacy_datasets.currency_options
...
def language_for(rep):
    ...
    return legacy_datasets.language_for(rep)
'''
    try:
...
def name_for_lang(rep):
    ...
    return legacy_datasets.name_for_lang(rep)
'''
    try:
...
def get_country_code(current_country, fail_if_not_found=False):
    ...
    return legacy_datasets.get_country_code(current_country, fail_if_not_found)
'''    
    try:
...
def get_currency_code(name):
    ...
    return legacy_datasets.get_currency_code(name)
'''
    try:
