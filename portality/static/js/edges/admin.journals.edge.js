...
doaj.adminJournalsSearch = {
    ...
    init : function(params) {
        ...
        var e = doaj.components.makeSearch({
            selector: selector,
            searchUrl: doaj.buildUrl(doaj.adminJournalsSearchConfig.searchPath),
            facets: [
                ...
                doaj.components.refiningAndFacet({id: "has_editor_group", field: "index.has_editor_group.exact", display: "Has editor group?", deactivateThreshold: 1}),
                ...
                doaj.components.refiningAndFacet({id: "journal_language", field: "index.language.exact", display: "Journal language", deactivateThreshold: 1, hideInactive: false}),
                ...
                doaj.components.refiningAndFacet({id: "continued", field: "index.continued.exact", display: "Continued", deactivateThreshold: 1}),
                doaj.components.yearDateHistogramFacet({id: "discontinued_date", field: "bibjson.discontinued_date", display: "Discontinued Year"}),
            ...
            resultsDisplay: edges.newResultsDisplay({
                ...
                renderer: doaj.renderers.newAdminBasicResultsRenderer({
                    ...
                    rightRowDisplay: [
                        ...
                        [{pre: "<strong>Date of Application</strong>: ", valueFunction: doaj.fieldRender.suggestedOn}],
                        [{pre: "<strong>Date published in DOAJ</strong>: ", valueFunction: doaj.fieldRender.createdDateWithTime}],
                        [{pre: "<strong>Last full review</strong>: ", valueFunction: doaj.fieldRender.lastFullReview}],
                        [{pre: "<strong>Last Withdrawn</strong>: ", valueFunction: doaj.fieldRender.lastWithdrawn}],
                        [{pre: "<strong>Last Reinstated</strong>: ", valueFunction: doaj.fieldRender.lastReinstated}],
                        [{pre: "<strong>Last Owner Transfer</strong>: ", valueFunction: doaj.fieldRender.lastOwnerTransfer}],
            ...
            valueMaps: {
                ...
                "bibjson.apc.has_apc": {true: "Yes", false: "No"},
                "bibjson.other_charges.has_other_charges": {true: "Yes", false: "No"}
            },
