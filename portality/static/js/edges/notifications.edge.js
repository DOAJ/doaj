...
doaj.notificationsSearch = {
    activeEdges: {},

    seen_url: "/dashboard/notifications/{notification_id}/seen",

    icons: {
        alert: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 448 512">
    ...
    init: function (params) {
        ...
        var e = edges.newEdge({
            ...
            search_url: doaj.buildUrl(doaj.notificationsSearchConfig.searchPath),
            manageUrl: false,
