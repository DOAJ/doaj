...
doaj.adminEditorGroupSearch = {
    ...
    init : function(params) {
        ...
        var e = doaj.components.makeSearch({
            selector: selector,
            searchUrl: doaj.buildUrl(doaj.adminEditorGroupSearchConfig.searchPath),
            facets: [
            ...
            resultsDisplay: edges.newResultsDisplay({
                ...
                renderer: edges.bs3.newResultsFieldsByRowRenderer({
                    rowDisplay: [
                        [{pre: "<h3>", field: "name", post: "</h3>"}],
                        [
                            {pre: 'Editor: <a href="/account/', field: "editor", post: '">'},
                            {field: "editor", post: "</a>"}
                        ],
                        [{valueFunction: doaj.adminEditorGroupSearch.linkedAssociates}],
                        [
                            {pre: 'Managing Editor: <a href="/account/', field: "maned", post: '">'},
                            {field: "maned", post: "</a>"}
                        ],
                        [
