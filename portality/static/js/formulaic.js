    ...
    widgets : {
            ...
            this.updateContents = function(element) {
                ...
                if (val) {
                    if (this.container) {
                        ...
                        var id = edges.css_id(this.ns, this.fieldDef.name);
                        that.after('<p id="' + id + '" class="' + classes + '"><strong>' + edges.escapeHtml(val) + '</strong></p>');
        ...
        NoteModal : function(params) {
            ...
            this.init = function() {
                ...
                for (var i = 0; i < this.divs.length; i++) {
                    ...
                    container.prepend(`<div><button href="#" class="` + viewClass + `">View note <span data-feather="eye" aria-hidden="true"/></button>
        ...
        InfiniteRepeat: function(params) {
            ...
            this.init = function() {
                ...
                for (var i = 0 ; i < this.divs.length; i++) {
                    var div = $(this.divs[i]);
                    div.append($('<div class="flex-end"><button type="button" data-id="' + i + '" id="remove_field__' + this.fieldDef["name"] + '--id_' + i + '" class="remove_field__button" style="display: none;">Remove <span data-feather="x" aria-hidden="true"/></button></div><hr/>'));
                    feather.replace();
                }
