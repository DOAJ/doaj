...
class Suggestion2QuestionXwalk(object):
    ...
    QTUP = [
        ...
        ("processing_charges_currency",         "16) Currency **"),
        ...
        ("submission_charges_currency",         "20) Currency **"),
        ...
        ("languages",                           "35) Select the language(s) that the Full Text of the articles is published in *"),
        ...
        ("plagiarism_screening_url",            "41) Enter the URL where this information can be found **"),
